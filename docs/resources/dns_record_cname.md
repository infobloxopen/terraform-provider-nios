...
page_title: "nios_dns_record_cname Resource - nios"
subcategory: "DNS"
description: |-
  Manages a DNS CNAME record.
---

# nios_dns_record_cname (Resource)
...
- `rr_precondition_instructions` (Attributes List) List of pre-condition instructions for CNAME record creation. (see [below for nested schema](#nestedatt--rr_precondition_instructions))
...
<a id="nestedatt--rr_precondition_instructions"></a>
### Nested Schema for `rr_precondition_instructions`
