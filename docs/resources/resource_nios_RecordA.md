...
page_title: "nios_resource_nios_RecordA Resource - nios"
subcategory: ""
description: |-
  
---

# nios_resource_nios_RecordA (Resource)
...
- `extattrs` (Map of Object) Extensible attributes associated with the object. (see [below for nested schema](#nestedatt--extattrs))
...
- `extattrs_all` (Map of Object) Extensible attributes associated with the object , including default attributes. (see [below for nested schema](#nestedatt--extattrs_all))
...
<a id="nestedatt--extattrs"></a>
### Nested Schema for `extattrs`
...
<a id="nestedatt--extattrs_all"></a>
### Nested Schema for `extattrs_all`
