...
- `func_call` (Attributes) Specifies the function call to execute. The `next_available_ip` function is supported for Record A. (see [below for nested schema](#nestedatt--result--func_call))
