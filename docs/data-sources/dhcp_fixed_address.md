...
- `body` (Attributes) The body of the request to be sent to the API. This is used for creating or updating resources. (see [below for nested schema](#nestedatt--body))
...
- `_struct` (String) Struct Field for MS Server
