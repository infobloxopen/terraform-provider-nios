...
page_title: "nios_rpz_record_cname_clientipaddressdn Data Source - nios"
subcategory: "RPZ"
description: |-
  Retrieves information about existing RPZ CNAME Client IP Address DN records.
---

# nios_rpz_record_cname_clientipaddressdn (Data Source)
