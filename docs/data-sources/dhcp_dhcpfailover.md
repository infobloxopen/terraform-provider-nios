...
page_title: "nios_dhcp_dhcpfailover Data Source - nios"
subcategory: "DHCP"
description: |-
  DHCP failover can be used to configure two DHCP servers to operate as a redundant pair.
---

# nios_dhcp_dhcpfailover (Data Source)
