...
page_title: "nios_dhcp_ipv6fixedaddress Data Source - nios"
subcategory: "DHCP"
description: |-
  Retrieves information about existing DHCP IPV6 Fixed Addresses.
---

# nios_dhcp_ipv6fixedaddress (Data Source)
...
- `cli_credentials` (Attributes List) The CLI credentials for the IPv6 fixed address. (see [below for nested schema](#nestedatt--result--cli_credentials))
