...
page_title: "nios_datasource_nios_RecordA Data Source - nios"
subcategory: ""
description: |-
  
---

# nios_datasource_nios_RecordA (Data Source)
...
- `extattrs` (Map of Object) Extensible attributes associated with the object. (see [below for nested schema](#nestedatt--result--extattrs))
...
- `extattrs_all` (Map of Object) Extensible attributes associated with the object , including default attributes. (see [below for nested schema](#nestedatt--result--extattrs_all))
...
<a id="nestedatt--result--extattrs"></a>
### Nested Schema for `result.extattrs`
...
<a id="nestedatt--result--extattrs_all"></a>
### Nested Schema for `result.extattrs_all`
