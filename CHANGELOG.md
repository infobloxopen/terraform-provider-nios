...
- `nios_dns_record_https` : Manage DNS HTTPS records and retrieve existing HTTPS records. ([#421](https://github.com/infobloxopen/terraform-provider-nios/pull/421))
- `nios_dns_record_svcb` : Manage DNS SVCB records and retrieve existing SVCB records. ([#419](https://github.com/infobloxopen/terraform-provider-nios/pull/419))
...
- `nios_rpz_record_cname` : Manage RPZ CNAME records and retrieve existing RPZ CNAME records. ([#321](https://github.com/infobloxopen/terraform-provider-nios/pull/321))
...
- `nios_rpz_record_cname_ipaddress` : Manage RPZ CNAME IP address records and retrieve existing RPZ CNAME IP address records. ([#289](https://github.com/infobloxopen/terraform-provider-nios/pull/289))
