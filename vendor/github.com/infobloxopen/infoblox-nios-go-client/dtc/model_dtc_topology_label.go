...
func (o *DtcTopologyLabel) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DtcTopologyLabel) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DtcTopologyLabel) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DtcTopologyLabel) SetUuid(v string) {
	o.Uuid = &v
}
