...
func (o *DtcRecordCname) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DtcRecordCname) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DtcRecordCname) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DtcRecordCname) SetUuid(v string) {
	o.Uuid = &v
}
