...
func (o *RecordRpzAIpaddress) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzAIpaddress) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzAIpaddress) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzAIpaddress) SetUuid(v string) {
	o.Uuid = &v
}
