...
func (o *RecordRpzCnameClientipaddress) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzCnameClientipaddress) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzCnameClientipaddress) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzCnameClientipaddress) SetUuid(v string) {
	o.Uuid = &v
}
