...
func (o *RecordRpzCname) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzCname) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzCname) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzCname) SetUuid(v string) {
	o.Uuid = &v
}
