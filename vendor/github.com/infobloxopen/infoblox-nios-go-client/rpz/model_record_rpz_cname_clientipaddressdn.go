...
func (o *RecordRpzCnameClientipaddressdn) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzCnameClientipaddressdn) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzCnameClientipaddressdn) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzCnameClientipaddressdn) SetUuid(v string) {
	o.Uuid = &v
}
