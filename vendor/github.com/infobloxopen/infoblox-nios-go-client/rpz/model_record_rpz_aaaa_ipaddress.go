...
func (o *RecordRpzAaaaIpaddress) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzAaaaIpaddress) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzAaaaIpaddress) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzAaaaIpaddress) SetUuid(v string) {
	o.Uuid = &v
}
