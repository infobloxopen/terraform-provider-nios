...
func (o *RecordRpzCnameIpaddressdn) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRpzCnameIpaddressdn) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordRpzCnameIpaddressdn) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordRpzCnameIpaddressdn) SetUuid(v string) {
	o.Uuid = &v
}
