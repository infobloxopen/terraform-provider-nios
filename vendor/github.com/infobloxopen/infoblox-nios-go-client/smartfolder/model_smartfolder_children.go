...
type SmartfolderChildren struct {
	...
	// The object returned by the Smart Folder query.
...
func (o *SmartfolderChildren) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *SmartfolderChildren) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *SmartfolderChildren) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *SmartfolderChildren) SetUuid(v string) {
	o.Uuid = &v
}
