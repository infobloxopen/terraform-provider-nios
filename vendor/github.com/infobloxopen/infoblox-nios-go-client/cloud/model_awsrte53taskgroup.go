...
func (o *Awsrte53taskgroup) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Awsrte53taskgroup) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Awsrte53taskgroup) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Awsrte53taskgroup) SetUuid(v string) {
	o.Uuid = &v
}
