...
func (o *Azurednstaskgroup) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Azurednstaskgroup) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Azurednstaskgroup) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Azurednstaskgroup) SetUuid(v string) {
	o.Uuid = &v
}
