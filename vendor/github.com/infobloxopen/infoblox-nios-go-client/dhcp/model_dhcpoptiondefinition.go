...
func (o *Dhcpoptiondefinition) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Dhcpoptiondefinition) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Dhcpoptiondefinition) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Dhcpoptiondefinition) SetUuid(v string) {
	o.Uuid = &v
}
