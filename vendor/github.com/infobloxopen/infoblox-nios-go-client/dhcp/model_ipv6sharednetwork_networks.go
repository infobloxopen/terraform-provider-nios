...
func (o *Ipv6sharednetworkNetworks) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Ipv6sharednetworkNetworks) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Ipv6sharednetworkNetworks) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Ipv6sharednetworkNetworks) SetUuid(v string) {
	o.Uuid = &v
}
