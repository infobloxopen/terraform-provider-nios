...
// APIClient manages communication with the Infoblox FEDERATEDREALMS API 2.13.6
// In most cases there should be only one, shared, APIClient.
type APIClient struct {
	*internal.APIClient

	// API Services
	FederatedrealmsAPI FederatedrealmsAPI
	FedipamopAPI FedipamopAPI
}
...
func NewAPIClient(options ...option.ClientOption) *APIClient {
	...
	// API Services
	c.FederatedrealmsAPI = (*FederatedrealmsAPIService)(&c.Common)
	c.FedipamopAPI = (*FedipamopAPIService)(&c.Common)
