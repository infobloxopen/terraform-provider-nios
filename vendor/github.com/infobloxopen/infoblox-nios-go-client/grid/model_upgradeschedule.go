...
func (o *Upgradeschedule) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Upgradeschedule) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Upgradeschedule) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Upgradeschedule) SetUuid(v string) {
	o.Uuid = &v
}
