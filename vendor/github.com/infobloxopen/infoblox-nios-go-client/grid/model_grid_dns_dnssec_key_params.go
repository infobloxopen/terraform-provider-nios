...
type GridDnsDnssecKeyParams struct {
	...
	// The minimum length for NSEC3 salts. RFC 9276 recommends empty salt (0 octets) for optimal resolver compatibility and reduced computational overhead.
	Nsec3SaltMinLength *int64 `json:"nsec3_salt_min_length,omitempty"`
	// The maximum length for NSEC3 salts. RFC 9276 recommends empty salt (0 octets) for optimal resolver compatibility and reduced computational overhead.
	Nsec3SaltMaxLength *int64 `json:"nsec3_salt_max_length,omitempty"`
	// The number of iterations used for hashing NSEC3. RFC 9276 Section 3.1 mandates that this value MUST be set to zero (0) to ensure DNSSEC resolver compatibility and alleviate computational burdens on validating resolvers.
