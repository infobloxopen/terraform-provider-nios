...
// checks if the MemberSyslogServersCertificateOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberSyslogServersCertificateOneOf{}

// MemberSyslogServersCertificateOneOf struct for MemberSyslogServersCertificateOneOf
type MemberSyslogServersCertificateOneOf struct {
...
type _MemberSyslogServersCertificateOneOf MemberSyslogServersCertificateOneOf
...
func NewMemberSyslogServersCertificateOneOf() *MemberSyslogServersCertificateOneOf {
	this := MemberSyslogServersCertificateOneOf{}
	return &this
}
...
func (o MemberSyslogServersCertificateOneOf) MarshalJSON() ([]byte, error) {
...
func (o MemberSyslogServersCertificateOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *MemberSyslogServersCertificateOneOf) UnmarshalJSON(data []byte) (err error) {
	varMemberSyslogServersCertificateOneOf := _MemberSyslogServersCertificateOneOf{}

	err = json.Unmarshal(data, &varMemberSyslogServersCertificateOneOf)

	if err != nil {
		return err
	}

	*o = MemberSyslogServersCertificateOneOf(varMemberSyslogServersCertificateOneOf)
...
type NullableMemberSyslogServersCertificateOneOf struct {
	value *MemberSyslogServersCertificateOneOf
	isSet bool
}

func (v NullableMemberSyslogServersCertificateOneOf) Get() *MemberSyslogServersCertificateOneOf {
	return v.value
}

func (v *NullableMemberSyslogServersCertificateOneOf) Set(val *MemberSyslogServersCertificateOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberSyslogServersCertificateOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberSyslogServersCertificateOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberSyslogServersCertificateOneOf(val *MemberSyslogServersCertificateOneOf) *NullableMemberSyslogServersCertificateOneOf {
	return &NullableMemberSyslogServersCertificateOneOf{value: val, isSet: true}
}

func (v NullableMemberSyslogServersCertificateOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberSyslogServersCertificateOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
