...
func (o *GridServicerestartStatus) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *GridServicerestartStatus) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *GridServicerestartStatus) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *GridServicerestartStatus) SetUuid(v string) {
	o.Uuid = &v
}
