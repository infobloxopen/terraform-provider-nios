...
type MemberDns struct {
	...
	// DoH end point. Available in WAPI 2.14 and later
	DnsOverHttpsEndpoint *string `json:"dns_over_https_endpoint,omitempty"`
	// DNS over HTTPS streams per connection. Available in WAPI 2.14 and later
	DnsOverHttpsStreamPerConnection *int64 `json:"dns_over_https_stream_per_connection,omitempty"`
	...
	// The DNSTAP identity string for this member.
	...
	// Enable DNSTAP for authoritative query messages.
	EnableDnstapAuthQueries *bool `json:"enable_dnstap_auth_queries,omitempty"`
	// Enable DNSTAP for authoritative response messages.
	EnableDnstapAuthResponses *bool `json:"enable_dnstap_auth_responses,omitempty"`
	// Enable DNSTAP for client query messages.
	EnableDnstapClientQueries *bool `json:"enable_dnstap_client_queries,omitempty"`
	// Enable DNSTAP for client response messages.
	EnableDnstapClientResponses *bool `json:"enable_dnstap_client_responses,omitempty"`
	// Enable DNSTAP for forwarder query messages.
	...
	// DNSTAP logging type for this member.
	...
	EnableDnstapResolverQueries *bool `json:"enable_dnstap_resolver_queries,omitempty"`
	// Enable DNSTAP for resolver response messages.
	EnableDnstapResolverResponses *bool `json:"enable_dnstap_resolver_responses,omitempty"`
	...
	// Indicates whether DNSTAP is enabled for this member.
	EnableDnstapSetting *bool `json:"enable_dnstap_setting,omitempty"`
	...
	// Use flag for: enable_dnstap_queries , enable_dnstap_responses, enable_dnstap_violations_tls, enable_dnstap_setting, enable_dnstap_logging_type, enable_dnstap_client_queries, enable_dnstap_resolver_queries, enable_dnstap_forwarder_queries, enable_dnstap_auth_queries, enable_dnstap_client_responses, enable_dnstap_resolver_responses, enable_dnstap_forwarder_responses, enable_dnstap_auth_responses, dnstap_setting
...
// GetDnsOverHttpsEndpoint returns the DnsOverHttpsEndpoint field value if set, zero value otherwise.
func (o *MemberDns) GetDnsOverHttpsEndpoint() string {
	if o == nil || IsNil(o.DnsOverHttpsEndpoint) {
		var ret string
		return ret
	}
	return *o.DnsOverHttpsEndpoint
}

// GetDnsOverHttpsEndpointOk returns a tuple with the DnsOverHttpsEndpoint field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetDnsOverHttpsEndpointOk() (*string, bool) {
	if o == nil || IsNil(o.DnsOverHttpsEndpoint) {
		return nil, false
	}
	return o.DnsOverHttpsEndpoint, true
}

// HasDnsOverHttpsEndpoint returns a boolean if a field has been set.
func (o *MemberDns) HasDnsOverHttpsEndpoint() bool {
	if o != nil && !IsNil(o.DnsOverHttpsEndpoint) {
		return true
	}
...
// SetDnsOverHttpsEndpoint gets a reference to the given string and assigns it to the DnsOverHttpsEndpoint field.
func (o *MemberDns) SetDnsOverHttpsEndpoint(v string) {
	o.DnsOverHttpsEndpoint = &v
}

// GetDnsOverHttpsStreamPerConnection returns the DnsOverHttpsStreamPerConnection field value if set, zero value otherwise.
func (o *MemberDns) GetDnsOverHttpsStreamPerConnection() int64 {
	if o == nil || IsNil(o.DnsOverHttpsStreamPerConnection) {
		var ret int64
		return ret
	}
	return *o.DnsOverHttpsStreamPerConnection
}

// GetDnsOverHttpsStreamPerConnectionOk returns a tuple with the DnsOverHttpsStreamPerConnection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetDnsOverHttpsStreamPerConnectionOk() (*int64, bool) {
	if o == nil || IsNil(o.DnsOverHttpsStreamPerConnection) {
		return nil, false
	}
	return o.DnsOverHttpsStreamPerConnection, true
}

// HasDnsOverHttpsStreamPerConnection returns a boolean if a field has been set.
func (o *MemberDns) HasDnsOverHttpsStreamPerConnection() bool {
	if o != nil && !IsNil(o.DnsOverHttpsStreamPerConnection) {
		return true
	}
...
// SetDnsOverHttpsStreamPerConnection gets a reference to the given int64 and assigns it to the DnsOverHttpsStreamPerConnection field.
func (o *MemberDns) SetDnsOverHttpsStreamPerConnection(v int64) {
	o.DnsOverHttpsStreamPerConnection = &v
}
...
func (o *MemberDns) GetDnstapIdentity() string {
...
// and a boolean to check if the value has been set.
func (o *MemberDns) GetDnstapIdentityOk() (*string, bool) {
	if o == nil || IsNil(o.DnstapIdentity) {
		return nil, false
	}
...
func (o *MemberDns) HasDnstapIdentity() bool {
	if o != nil && !IsNil(o.DnstapIdentity) {
		return true
	}
...
func (o *MemberDns) SetDnstapIdentity(v string) {
	o.DnstapIdentity = &v
}
...
// GetEnableDnstapAuthQueries returns the EnableDnstapAuthQueries field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapAuthQueries() bool {
	if o == nil || IsNil(o.EnableDnstapAuthQueries) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapAuthQueries
}

// GetEnableDnstapAuthQueriesOk returns a tuple with the EnableDnstapAuthQueries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapAuthQueriesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapAuthQueries) {
		return nil, false
	}
	return o.EnableDnstapAuthQueries, true
}

// HasEnableDnstapAuthQueries returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapAuthQueries() bool {
	if o != nil && !IsNil(o.EnableDnstapAuthQueries) {
		return true
	}
...
// SetEnableDnstapAuthQueries gets a reference to the given bool and assigns it to the EnableDnstapAuthQueries field.
func (o *MemberDns) SetEnableDnstapAuthQueries(v bool) {
	o.EnableDnstapAuthQueries = &v
}

// GetEnableDnstapAuthResponses returns the EnableDnstapAuthResponses field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapAuthResponses() bool {
	if o == nil || IsNil(o.EnableDnstapAuthResponses) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapAuthResponses
}

// GetEnableDnstapAuthResponsesOk returns a tuple with the EnableDnstapAuthResponses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapAuthResponsesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapAuthResponses) {
		return nil, false
	}
	return o.EnableDnstapAuthResponses, true
}

// HasEnableDnstapAuthResponses returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapAuthResponses() bool {
	if o != nil && !IsNil(o.EnableDnstapAuthResponses) {
		return true
	}
...
// SetEnableDnstapAuthResponses gets a reference to the given bool and assigns it to the EnableDnstapAuthResponses field.
func (o *MemberDns) SetEnableDnstapAuthResponses(v bool) {
	o.EnableDnstapAuthResponses = &v
}

// GetEnableDnstapClientQueries returns the EnableDnstapClientQueries field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapClientQueries() bool {
	if o == nil || IsNil(o.EnableDnstapClientQueries) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapClientQueries
}

// GetEnableDnstapClientQueriesOk returns a tuple with the EnableDnstapClientQueries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapClientQueriesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapClientQueries) {
		return nil, false
	}
	return o.EnableDnstapClientQueries, true
}

// HasEnableDnstapClientQueries returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapClientQueries() bool {
	if o != nil && !IsNil(o.EnableDnstapClientQueries) {
		return true
	}
...
// SetEnableDnstapClientQueries gets a reference to the given bool and assigns it to the EnableDnstapClientQueries field.
func (o *MemberDns) SetEnableDnstapClientQueries(v bool) {
	o.EnableDnstapClientQueries = &v
}

// GetEnableDnstapClientResponses returns the EnableDnstapClientResponses field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapClientResponses() bool {
	if o == nil || IsNil(o.EnableDnstapClientResponses) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapClientResponses
}

// GetEnableDnstapClientResponsesOk returns a tuple with the EnableDnstapClientResponses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapClientResponsesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapClientResponses) {
		return nil, false
	}
	return o.EnableDnstapClientResponses, true
}

// HasEnableDnstapClientResponses returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapClientResponses() bool {
	if o != nil && !IsNil(o.EnableDnstapClientResponses) {
		return true
	}
...
// SetEnableDnstapClientResponses gets a reference to the given bool and assigns it to the EnableDnstapClientResponses field.
func (o *MemberDns) SetEnableDnstapClientResponses(v bool) {
	o.EnableDnstapClientResponses = &v
}

// GetEnableDnstapForwarderQueries returns the EnableDnstapForwarderQueries field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapForwarderQueries() bool {
	if o == nil || IsNil(o.EnableDnstapForwarderQueries) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapForwarderQueries
}

// GetEnableDnstapForwarderQueriesOk returns a tuple with the EnableDnstapForwarderQueries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapForwarderQueriesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapForwarderQueries) {
		return nil, false
	}
	return o.EnableDnstapForwarderQueries, true
}

// HasEnableDnstapForwarderQueries returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapForwarderQueries() bool {
	if o != nil && !IsNil(o.EnableDnstapForwarderQueries) {
		return true
	}
...
// SetEnableDnstapForwarderQueries gets a reference to the given bool and assigns it to the EnableDnstapForwarderQueries field.
func (o *MemberDns) SetEnableDnstapForwarderQueries(v bool) {
	o.EnableDnstapForwarderQueries = &v
}

// GetEnableDnstapForwarderResponses returns the EnableDnstapForwarderResponses field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapForwarderResponses() bool {
	if o == nil || IsNil(o.EnableDnstapForwarderResponses) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapForwarderResponses
}

// GetEnableDnstapForwarderResponsesOk returns a tuple with the EnableDnstapForwarderResponses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapForwarderResponsesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapForwarderResponses) {
		return nil, false
	}
	return o.EnableDnstapForwarderResponses, true
}

// HasEnableDnstapForwarderResponses returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapForwarderResponses() bool {
	if o != nil && !IsNil(o.EnableDnstapForwarderResponses) {
		return true
	}
...
// SetEnableDnstapForwarderResponses gets a reference to the given bool and assigns it to the EnableDnstapForwarderResponses field.
func (o *MemberDns) SetEnableDnstapForwarderResponses(v bool) {
...
func (o *MemberDns) GetEnableDnstapLoggingType() bool {
...
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapLoggingTypeOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapLoggingType) {
		return nil, false
	}
...
func (o *MemberDns) HasEnableDnstapLoggingType() bool {
	if o != nil && !IsNil(o.EnableDnstapLoggingType) {
		return true
	}
...
func (o *MemberDns) SetEnableDnstapLoggingType(v bool) {
...
// GetEnableDnstapResolverQueries returns the EnableDnstapResolverQueries field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapResolverQueries() bool {
	if o == nil || IsNil(o.EnableDnstapResolverQueries) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapResolverQueries
}

// GetEnableDnstapResolverQueriesOk returns a tuple with the EnableDnstapResolverQueries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapResolverQueriesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapResolverQueries) {
		return nil, false
	}
	return o.EnableDnstapResolverQueries, true
}

// HasEnableDnstapResolverQueries returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapResolverQueries() bool {
	if o != nil && !IsNil(o.EnableDnstapResolverQueries) {
		return true
	}
...
// SetEnableDnstapResolverQueries gets a reference to the given bool and assigns it to the EnableDnstapResolverQueries field.
func (o *MemberDns) SetEnableDnstapResolverQueries(v bool) {
	o.EnableDnstapResolverQueries = &v
}

// GetEnableDnstapResolverResponses returns the EnableDnstapResolverResponses field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapResolverResponses() bool {
	if o == nil || IsNil(o.EnableDnstapResolverResponses) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapResolverResponses
}

// GetEnableDnstapResolverResponsesOk returns a tuple with the EnableDnstapResolverResponses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapResolverResponsesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapResolverResponses) {
		return nil, false
	}
	return o.EnableDnstapResolverResponses, true
}

// HasEnableDnstapResolverResponses returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapResolverResponses() bool {
	if o != nil && !IsNil(o.EnableDnstapResolverResponses) {
		return true
	}
...
// SetEnableDnstapResolverResponses gets a reference to the given bool and assigns it to the EnableDnstapResolverResponses field.
func (o *MemberDns) SetEnableDnstapResolverResponses(v bool) {
	o.EnableDnstapResolverResponses = &v
}
...
// GetEnableDnstapSetting returns the EnableDnstapSetting field value if set, zero value otherwise.
func (o *MemberDns) GetEnableDnstapSetting() bool {
	if o == nil || IsNil(o.EnableDnstapSetting) {
		var ret bool
		return ret
	}
	return *o.EnableDnstapSetting
}

// GetEnableDnstapSettingOk returns a tuple with the EnableDnstapSetting field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDns) GetEnableDnstapSettingOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDnstapSetting) {
		return nil, false
	}
	return o.EnableDnstapSetting, true
}

// HasEnableDnstapSetting returns a boolean if a field has been set.
func (o *MemberDns) HasEnableDnstapSetting() bool {
	if o != nil && !IsNil(o.EnableDnstapSetting) {
		return true
	}
...
// SetEnableDnstapSetting gets a reference to the given bool and assigns it to the EnableDnstapSetting field.
func (o *MemberDns) SetEnableDnstapSetting(v bool) {
	o.EnableDnstapSetting = &v
}
...
func (o MemberDns) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DnsOverHttpsEndpoint) {
		toSerialize["dns_over_https_endpoint"] = o.DnsOverHttpsEndpoint
	}
	if !IsNil(o.DnsOverHttpsStreamPerConnection) {
		toSerialize["dns_over_https_stream_per_connection"] = o.DnsOverHttpsStreamPerConnection
	}
	...
	if !IsNil(o.EnableDnstapAuthQueries) {
		toSerialize["enable_dnstap_auth_queries"] = o.EnableDnstapAuthQueries
	}
	if !IsNil(o.EnableDnstapAuthResponses) {
		toSerialize["enable_dnstap_auth_responses"] = o.EnableDnstapAuthResponses
	}
	if !IsNil(o.EnableDnstapClientQueries) {
		toSerialize["enable_dnstap_client_queries"] = o.EnableDnstapClientQueries
	}
	if !IsNil(o.EnableDnstapClientResponses) {
		toSerialize["enable_dnstap_client_responses"] = o.EnableDnstapClientResponses
	}
	if !IsNil(o.EnableDnstapForwarderQueries) {
		toSerialize["enable_dnstap_forwarder_queries"] = o.EnableDnstapForwarderQueries
	}
	...
	if !IsNil(o.EnableDnstapResolverQueries) {
		toSerialize["enable_dnstap_resolver_queries"] = o.EnableDnstapResolverQueries
	}
	if !IsNil(o.EnableDnstapResolverResponses) {
		toSerialize["enable_dnstap_resolver_responses"] = o.EnableDnstapResolverResponses
	}
	if !IsNil(o.EnableDnstapResponses) {
		toSerialize["enable_dnstap_responses"] = o.EnableDnstapResponses
	}
	if !IsNil(o.EnableDnstapSetting) {
		toSerialize["enable_dnstap_setting"] = o.EnableDnstapSetting
	}
