...
type GridCspGridSetting struct {
	...
	// Username for HTTPS proxy used to access the CSP Portal
	CspHttpsProxyUsername *string `json:"csp_https_proxy_username,omitempty"`
	// Password for HTTPS proxy used to access the CSP Portal. This is write-only.
...
func (o *GridCspGridSetting) GetCspHttpsProxyUsername() string {
...
// and a boolean to check if the value has been set.
func (o *GridCspGridSetting) GetCspHttpsProxyUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.CspHttpsProxyUsername) {
		return nil, false
	}
...
func (o *GridCspGridSetting) HasCspHttpsProxyUsername() bool {
	if o != nil && !IsNil(o.CspHttpsProxyUsername) {
		return true
	}
...
func (o *GridCspGridSetting) SetCspHttpsProxyUsername(v string) {
...
func (o *GridCspGridSetting) GetCspHttpsProxyPassword() string {
...
// and a boolean to check if the value has been set.
func (o *GridCspGridSetting) GetCspHttpsProxyPasswordOk() (*string, bool) {
	if o == nil || IsNil(o.CspHttpsProxyPassword) {
		return nil, false
	}
...
func (o *GridCspGridSetting) HasCspHttpsProxyPassword() bool {
	if o != nil && !IsNil(o.CspHttpsProxyPassword) {
		return true
	}
...
func (o *GridCspGridSetting) SetCspHttpsProxyPassword(v string) {
