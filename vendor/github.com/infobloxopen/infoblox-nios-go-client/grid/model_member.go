...
type Member struct {
	...
	// Determines if a Grid member is a Grid Master or not.
...
func (o *Member) GetIsMaster() bool {
...
// and a boolean to check if the value has been set.
func (o *Member) GetIsMasterOk() (*bool, bool) {
	if o == nil || IsNil(o.IsMaster) {
		return nil, false
	}
...
func (o *Member) HasIsMaster() bool {
	if o != nil && !IsNil(o.IsMaster) {
		return true
	}
...
func (o *Member) SetIsMaster(v bool) {
	o.IsMaster = &v
}
