...
func (o *Membercloudsync) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Membercloudsync) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Membercloudsync) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Membercloudsync) SetUuid(v string) {
	o.Uuid = &v
}
