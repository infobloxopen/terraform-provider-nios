...
func (o *HsmThaleslunagroup) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *HsmThaleslunagroup) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *HsmThaleslunagroup) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *HsmThaleslunagroup) SetUuid(v string) {
	o.Uuid = &v
}
