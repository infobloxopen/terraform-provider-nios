...
func (o *CertificateAuthserviceOcspRespondersCertificateOneOf) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *CertificateAuthserviceOcspRespondersCertificateOneOf) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *CertificateAuthserviceOcspRespondersCertificateOneOf) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *CertificateAuthserviceOcspRespondersCertificateOneOf) SetUuid(v string) {
	o.Uuid = &v
}
