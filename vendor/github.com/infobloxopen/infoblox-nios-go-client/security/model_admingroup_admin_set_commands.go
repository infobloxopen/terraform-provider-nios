...
type AdmingroupAdminSetCommands struct {
	...
	// If True then CLI user has permission to run the command
	SetQueryLoggingWarnings *bool `json:"set_query_logging_warnings,omitempty"`
...
// GetSetQueryLoggingWarnings returns the SetQueryLoggingWarnings field value if set, zero value otherwise.
func (o *AdmingroupAdminSetCommands) GetSetQueryLoggingWarnings() bool {
	if o == nil || IsNil(o.SetQueryLoggingWarnings) {
		var ret bool
		return ret
	}
	return *o.SetQueryLoggingWarnings
}

// GetSetQueryLoggingWarningsOk returns a tuple with the SetQueryLoggingWarnings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AdmingroupAdminSetCommands) GetSetQueryLoggingWarningsOk() (*bool, bool) {
	if o == nil || IsNil(o.SetQueryLoggingWarnings) {
		return nil, false
	}
	return o.SetQueryLoggingWarnings, true
}
...
// SetSetQueryLoggingWarnings gets a reference to the given bool and assigns it to the SetQueryLoggingWarnings field.
func (o *AdmingroupAdminSetCommands) SetSetQueryLoggingWarnings(v bool) {
	o.SetQueryLoggingWarnings = &v
}
...
func (o AdmingroupAdminSetCommands) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SetQueryLoggingWarnings) {
		toSerialize["set_query_logging_warnings"] = o.SetQueryLoggingWarnings
	}
...
func (o *AdmingroupAdminSetCommands) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AdmingroupAdminSetCommands(varAdmingroupAdminSetCommands)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "set_query_logging_warnings")
