...
func (o *ParentalcontrolBlockingpolicy) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ParentalcontrolBlockingpolicy) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ParentalcontrolBlockingpolicy) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ParentalcontrolBlockingpolicy) SetUuid(v string) {
	o.Uuid = &v
}
