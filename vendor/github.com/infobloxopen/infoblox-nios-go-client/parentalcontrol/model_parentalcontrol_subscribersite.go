...
type ParentalcontrolSubscribersite struct {
	...
	// Enable/disable global content filter policy over allowed list.
	EnableGcpPrecedenceOverAllowedList *bool `json:"enable_gcp_precedence_over_allowed_list,omitempty"`
	// Enable/disable global allow list RPZ setting.
	EnableGlobalAllowListRpz *bool `json:"enable_global_allow_list_rpz,omitempty"`
	// Enable/disable global content policy setting.
	EnableGlobalContentPolicy *bool `json:"enable_global_content_policy,omitempty"`
	...
	// Global content filter policy bit numbers in range of 0 to 127.
	GlobalContentPolicyBitNumbers *string `json:"global_content_policy_bit_numbers,omitempty"`
...
// GetEnableGcpPrecedenceOverAllowedList returns the EnableGcpPrecedenceOverAllowedList field value if set, zero value otherwise.
func (o *ParentalcontrolSubscribersite) GetEnableGcpPrecedenceOverAllowedList() bool {
	if o == nil || IsNil(o.EnableGcpPrecedenceOverAllowedList) {
		var ret bool
		return ret
	}
	return *o.EnableGcpPrecedenceOverAllowedList
}

// GetEnableGcpPrecedenceOverAllowedListOk returns a tuple with the EnableGcpPrecedenceOverAllowedList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParentalcontrolSubscribersite) GetEnableGcpPrecedenceOverAllowedListOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableGcpPrecedenceOverAllowedList) {
		return nil, false
	}
	return o.EnableGcpPrecedenceOverAllowedList, true
}
...
// SetEnableGcpPrecedenceOverAllowedList gets a reference to the given bool and assigns it to the EnableGcpPrecedenceOverAllowedList field.
func (o *ParentalcontrolSubscribersite) SetEnableGcpPrecedenceOverAllowedList(v bool) {
	o.EnableGcpPrecedenceOverAllowedList = &v
}
...
// GetEnableGlobalContentPolicy returns the EnableGlobalContentPolicy field value if set, zero value otherwise.
func (o *ParentalcontrolSubscribersite) GetEnableGlobalContentPolicy() bool {
	if o == nil || IsNil(o.EnableGlobalContentPolicy) {
		var ret bool
		return ret
	}
	return *o.EnableGlobalContentPolicy
}

// GetEnableGlobalContentPolicyOk returns a tuple with the EnableGlobalContentPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParentalcontrolSubscribersite) GetEnableGlobalContentPolicyOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableGlobalContentPolicy) {
		return nil, false
	}
	return o.EnableGlobalContentPolicy, true
}
...
// SetEnableGlobalContentPolicy gets a reference to the given bool and assigns it to the EnableGlobalContentPolicy field.
func (o *ParentalcontrolSubscribersite) SetEnableGlobalContentPolicy(v bool) {
	o.EnableGlobalContentPolicy = &v
}
...
// GetGlobalContentPolicyBitNumbers returns the GlobalContentPolicyBitNumbers field value if set, zero value otherwise.
func (o *ParentalcontrolSubscribersite) GetGlobalContentPolicyBitNumbers() string {
	if o == nil || IsNil(o.GlobalContentPolicyBitNumbers) {
		var ret string
		return ret
	}
	return *o.GlobalContentPolicyBitNumbers
}

// GetGlobalContentPolicyBitNumbersOk returns a tuple with the GlobalContentPolicyBitNumbers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParentalcontrolSubscribersite) GetGlobalContentPolicyBitNumbersOk() (*string, bool) {
	if o == nil || IsNil(o.GlobalContentPolicyBitNumbers) {
		return nil, false
	}
	return o.GlobalContentPolicyBitNumbers, true
}
...
// SetGlobalContentPolicyBitNumbers gets a reference to the given string and assigns it to the GlobalContentPolicyBitNumbers field.
func (o *ParentalcontrolSubscribersite) SetGlobalContentPolicyBitNumbers(v string) {
	o.GlobalContentPolicyBitNumbers = &v
}
...
func (o ParentalcontrolSubscribersite) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnableGcpPrecedenceOverAllowedList) {
		toSerialize["enable_gcp_precedence_over_allowed_list"] = o.EnableGcpPrecedenceOverAllowedList
	}
	if !IsNil(o.EnableGlobalAllowListRpz) {
		toSerialize["enable_global_allow_list_rpz"] = o.EnableGlobalAllowListRpz
	}
	if !IsNil(o.EnableGlobalContentPolicy) {
		toSerialize["enable_global_content_policy"] = o.EnableGlobalContentPolicy
	}
	...
	if !IsNil(o.GlobalContentPolicyBitNumbers) {
		toSerialize["global_content_policy_bit_numbers"] = o.GlobalContentPolicyBitNumbers
	}
