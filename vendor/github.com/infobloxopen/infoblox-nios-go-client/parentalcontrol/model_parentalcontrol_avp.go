...
func (o *ParentalcontrolAvp) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ParentalcontrolAvp) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ParentalcontrolAvp) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ParentalcontrolAvp) SetUuid(v string) {
	o.Uuid = &v
}
