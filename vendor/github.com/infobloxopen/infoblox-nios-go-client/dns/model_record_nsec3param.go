...
func (o *RecordNsec3param) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RecordNsec3param) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RecordNsec3param) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RecordNsec3param) SetUuid(v string) {
	o.Uuid = &v
}
