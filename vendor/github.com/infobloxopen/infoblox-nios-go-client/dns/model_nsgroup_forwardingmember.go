...
func (o *NsgroupForwardingmember) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *NsgroupForwardingmember) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *NsgroupForwardingmember) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *NsgroupForwardingmember) SetUuid(v string) {
	o.Uuid = &v
}
