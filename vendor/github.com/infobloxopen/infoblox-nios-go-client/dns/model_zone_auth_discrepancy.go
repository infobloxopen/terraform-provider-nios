...
func (o *ZoneAuthDiscrepancy) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ZoneAuthDiscrepancy) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ZoneAuthDiscrepancy) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ZoneAuthDiscrepancy) SetUuid(v string) {
	o.Uuid = &v
}
