...
func (o *NsgroupStubmember) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *NsgroupStubmember) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *NsgroupStubmember) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *NsgroupStubmember) SetUuid(v string) {
	o.Uuid = &v
}
