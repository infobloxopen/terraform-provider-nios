...
type View struct {
	...
	// The action to perform when a domain name matches the pattern defined in a rule that is specified by the blacklist_ruleset method. Valid values are \"REDIRECT\" or \"REFUSE\". The default value is \"REDIRECT\".
	...
	// Applies AAAA filtering to a named ACL, or to a list of IPv4 addresses and networks from which queries are received. This field does not allow TSIG keys.
