...
func (o *Recordnamepolicy) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Recordnamepolicy) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Recordnamepolicy) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Recordnamepolicy) SetUuid(v string) {
	o.Uuid = &v
}
