...
func (o *SharedrecordCname) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *SharedrecordCname) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *SharedrecordCname) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *SharedrecordCname) SetUuid(v string) {
	o.Uuid = &v
}
