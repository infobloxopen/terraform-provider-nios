...
func (o *NsgroupDelegation) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *NsgroupDelegation) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *NsgroupDelegation) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *NsgroupDelegation) SetUuid(v string) {
	o.Uuid = &v
}
