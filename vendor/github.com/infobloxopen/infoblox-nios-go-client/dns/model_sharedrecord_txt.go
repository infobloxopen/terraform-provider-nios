...
func (o *SharedrecordTxt) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *SharedrecordTxt) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *SharedrecordTxt) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *SharedrecordTxt) SetUuid(v string) {
	o.Uuid = &v
}
