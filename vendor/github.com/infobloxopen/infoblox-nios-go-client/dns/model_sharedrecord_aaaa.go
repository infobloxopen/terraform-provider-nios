...
func (o *SharedrecordAaaa) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *SharedrecordAaaa) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *SharedrecordAaaa) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *SharedrecordAaaa) SetUuid(v string) {
	o.Uuid = &v
}
