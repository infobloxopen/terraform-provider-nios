...
// checks if the RecordSvcbCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordSvcbCloudInfo{}

// RecordSvcbCloudInfo struct for RecordSvcbCloudInfo
type RecordSvcbCloudInfo struct {
	DelegatedMember *RecordsvcbcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordSvcbCloudInfo RecordSvcbCloudInfo

// NewRecordSvcbCloudInfo instantiates a new RecordSvcbCloudInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordSvcbCloudInfo() *RecordSvcbCloudInfo {
	this := RecordSvcbCloudInfo{}
	return &this
}

// NewRecordSvcbCloudInfoWithDefaults instantiates a new RecordSvcbCloudInfo object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRecordSvcbCloudInfoWithDefaults() *RecordSvcbCloudInfo {
	this := RecordSvcbCloudInfo{}
	return &this
}

// GetDelegatedMember returns the DelegatedMember field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetDelegatedMember() RecordsvcbcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordsvcbcloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordSvcbCloudInfo) GetDelegatedMemberOk() (*RecordsvcbcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasDelegatedMember() bool {
	if o != nil && !IsNil(o.DelegatedMember) {
		return true
	}
...
// SetDelegatedMember gets a reference to the given RecordsvcbcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
func (o *RecordSvcbCloudInfo) SetDelegatedMember(v RecordsvcbcloudinfoDelegatedMember) {
	o.DelegatedMember = &v
}

// GetDelegatedScope returns the DelegatedScope field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetDelegatedScope() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetDelegatedScopeOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedScope) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasDelegatedScope() bool {
	if o != nil && !IsNil(o.DelegatedScope) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetDelegatedScope(v string) {
	o.DelegatedScope = &v
}

// GetDelegatedRoot returns the DelegatedRoot field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetDelegatedRoot() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetDelegatedRootOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedRoot) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasDelegatedRoot() bool {
	if o != nil && !IsNil(o.DelegatedRoot) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetDelegatedRoot(v string) {
	o.DelegatedRoot = &v
}

// GetOwnedByAdaptor returns the OwnedByAdaptor field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetOwnedByAdaptor() bool {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetOwnedByAdaptorOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnedByAdaptor) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasOwnedByAdaptor() bool {
	if o != nil && !IsNil(o.OwnedByAdaptor) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetOwnedByAdaptor(v bool) {
	o.OwnedByAdaptor = &v
}

// GetUsage returns the Usage field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetUsage() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetUsageOk() (*string, bool) {
	if o == nil || IsNil(o.Usage) {
		return nil, false
	}
	return o.Usage, true
...
func (o *RecordSvcbCloudInfo) HasUsage() bool {
	if o != nil && !IsNil(o.Usage) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetUsage(v string) {
	o.Usage = &v
}

// GetTenant returns the Tenant field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetTenant() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetTenantOk() (*string, bool) {
	if o == nil || IsNil(o.Tenant) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasTenant() bool {
	if o != nil && !IsNil(o.Tenant) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetTenant(v string) {
	o.Tenant = &v
}

// GetMgmtPlatform returns the MgmtPlatform field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetMgmtPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetMgmtPlatformOk() (*string, bool) {
	if o == nil || IsNil(o.MgmtPlatform) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasMgmtPlatform() bool {
	if o != nil && !IsNil(o.MgmtPlatform) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetMgmtPlatform(v string) {
	o.MgmtPlatform = &v
}

// GetAuthorityType returns the AuthorityType field value if set, zero value otherwise.
func (o *RecordSvcbCloudInfo) GetAuthorityType() string {
...
// and a boolean to check if the value has been set.
func (o *RecordSvcbCloudInfo) GetAuthorityTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorityType) {
		return nil, false
	}
...
func (o *RecordSvcbCloudInfo) HasAuthorityType() bool {
	if o != nil && !IsNil(o.AuthorityType) {
		return true
	}
...
func (o *RecordSvcbCloudInfo) SetAuthorityType(v string) {
	o.AuthorityType = &v
}

func (o RecordSvcbCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordSvcbCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordSvcbCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordSvcbCloudInfo := _RecordSvcbCloudInfo{}

	err = json.Unmarshal(data, &varRecordSvcbCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordSvcbCloudInfo(varRecordSvcbCloudInfo)
...
type NullableRecordSvcbCloudInfo struct {
	value *RecordSvcbCloudInfo
	isSet bool
}

func (v NullableRecordSvcbCloudInfo) Get() *RecordSvcbCloudInfo {
	return v.value
}

func (v *NullableRecordSvcbCloudInfo) Set(val *RecordSvcbCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordSvcbCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordSvcbCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordSvcbCloudInfo(val *RecordSvcbCloudInfo) *NullableRecordSvcbCloudInfo {
	return &NullableRecordSvcbCloudInfo{value: val, isSet: true}
}

func (v NullableRecordSvcbCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordSvcbCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
