...
func (o *ZoneAuthAllowQuery) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ZoneAuthAllowQuery) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ZoneAuthAllowQuery) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ZoneAuthAllowQuery) SetUuid(v string) {
	o.Uuid = &v
}
