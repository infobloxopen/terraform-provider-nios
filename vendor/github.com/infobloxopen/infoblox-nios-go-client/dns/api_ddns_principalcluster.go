...
func (r DdnsPrincipalclusterAPIListRequest) ProxySearch(proxySearch string) DdnsPrincipalclusterAPIListRequest {
...
// Search Grid members for data
func (r DdnsPrincipalclusterAPIReadRequest) ProxySearch(proxySearch string) DdnsPrincipalclusterAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
