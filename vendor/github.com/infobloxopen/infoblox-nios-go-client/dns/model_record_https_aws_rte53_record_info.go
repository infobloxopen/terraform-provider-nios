...
// checks if the RecordHttpsAwsRte53RecordInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordHttpsAwsRte53RecordInfo{}

// RecordHttpsAwsRte53RecordInfo struct for RecordHttpsAwsRte53RecordInfo
type RecordHttpsAwsRte53RecordInfo struct {
...
type _RecordHttpsAwsRte53RecordInfo RecordHttpsAwsRte53RecordInfo
...
func NewRecordHttpsAwsRte53RecordInfo() *RecordHttpsAwsRte53RecordInfo {
	this := RecordHttpsAwsRte53RecordInfo{}
	return &this
}
...
func (o RecordHttpsAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordHttpsAwsRte53RecordInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordHttpsAwsRte53RecordInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordHttpsAwsRte53RecordInfo := _RecordHttpsAwsRte53RecordInfo{}

	err = json.Unmarshal(data, &varRecordHttpsAwsRte53RecordInfo)

	if err != nil {
		return err
	}

	*o = RecordHttpsAwsRte53RecordInfo(varRecordHttpsAwsRte53RecordInfo)
...
type NullableRecordHttpsAwsRte53RecordInfo struct {
	value *RecordHttpsAwsRte53RecordInfo
	isSet bool
}

func (v NullableRecordHttpsAwsRte53RecordInfo) Get() *RecordHttpsAwsRte53RecordInfo {
	return v.value
}

func (v *NullableRecordHttpsAwsRte53RecordInfo) Set(val *RecordHttpsAwsRte53RecordInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordHttpsAwsRte53RecordInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordHttpsAwsRte53RecordInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordHttpsAwsRte53RecordInfo(val *RecordHttpsAwsRte53RecordInfo) *NullableRecordHttpsAwsRte53RecordInfo {
	return &NullableRecordHttpsAwsRte53RecordInfo{value: val, isSet: true}
}

func (v NullableRecordHttpsAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordHttpsAwsRte53RecordInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
