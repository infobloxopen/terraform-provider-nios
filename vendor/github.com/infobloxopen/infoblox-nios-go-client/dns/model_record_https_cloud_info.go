...
// checks if the RecordHttpsCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordHttpsCloudInfo{}

// RecordHttpsCloudInfo struct for RecordHttpsCloudInfo
type RecordHttpsCloudInfo struct {
	DelegatedMember *RecordhttpscloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordHttpsCloudInfo RecordHttpsCloudInfo

// NewRecordHttpsCloudInfo instantiates a new RecordHttpsCloudInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordHttpsCloudInfo() *RecordHttpsCloudInfo {
	this := RecordHttpsCloudInfo{}
	return &this
}

// NewRecordHttpsCloudInfoWithDefaults instantiates a new RecordHttpsCloudInfo object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRecordHttpsCloudInfoWithDefaults() *RecordHttpsCloudInfo {
	this := RecordHttpsCloudInfo{}
	return &this
}

// GetDelegatedMember returns the DelegatedMember field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetDelegatedMember() RecordhttpscloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordhttpscloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordHttpsCloudInfo) GetDelegatedMemberOk() (*RecordhttpscloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasDelegatedMember() bool {
	if o != nil && !IsNil(o.DelegatedMember) {
		return true
	}
...
// SetDelegatedMember gets a reference to the given RecordhttpscloudinfoDelegatedMember and assigns it to the DelegatedMember field.
func (o *RecordHttpsCloudInfo) SetDelegatedMember(v RecordhttpscloudinfoDelegatedMember) {
	o.DelegatedMember = &v
}

// GetDelegatedScope returns the DelegatedScope field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetDelegatedScope() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetDelegatedScopeOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedScope) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasDelegatedScope() bool {
	if o != nil && !IsNil(o.DelegatedScope) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetDelegatedScope(v string) {
	o.DelegatedScope = &v
}

// GetDelegatedRoot returns the DelegatedRoot field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetDelegatedRoot() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetDelegatedRootOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedRoot) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasDelegatedRoot() bool {
	if o != nil && !IsNil(o.DelegatedRoot) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetDelegatedRoot(v string) {
	o.DelegatedRoot = &v
}

// GetOwnedByAdaptor returns the OwnedByAdaptor field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetOwnedByAdaptor() bool {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetOwnedByAdaptorOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnedByAdaptor) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasOwnedByAdaptor() bool {
	if o != nil && !IsNil(o.OwnedByAdaptor) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetOwnedByAdaptor(v bool) {
	o.OwnedByAdaptor = &v
}

// GetUsage returns the Usage field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetUsage() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetUsageOk() (*string, bool) {
	if o == nil || IsNil(o.Usage) {
		return nil, false
	}
	return o.Usage, true
...
func (o *RecordHttpsCloudInfo) HasUsage() bool {
	if o != nil && !IsNil(o.Usage) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetUsage(v string) {
	o.Usage = &v
}

// GetTenant returns the Tenant field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetTenant() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetTenantOk() (*string, bool) {
	if o == nil || IsNil(o.Tenant) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasTenant() bool {
	if o != nil && !IsNil(o.Tenant) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetTenant(v string) {
	o.Tenant = &v
}

// GetMgmtPlatform returns the MgmtPlatform field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetMgmtPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetMgmtPlatformOk() (*string, bool) {
	if o == nil || IsNil(o.MgmtPlatform) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasMgmtPlatform() bool {
	if o != nil && !IsNil(o.MgmtPlatform) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetMgmtPlatform(v string) {
	o.MgmtPlatform = &v
}

// GetAuthorityType returns the AuthorityType field value if set, zero value otherwise.
func (o *RecordHttpsCloudInfo) GetAuthorityType() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHttpsCloudInfo) GetAuthorityTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorityType) {
		return nil, false
	}
...
func (o *RecordHttpsCloudInfo) HasAuthorityType() bool {
	if o != nil && !IsNil(o.AuthorityType) {
		return true
	}
...
func (o *RecordHttpsCloudInfo) SetAuthorityType(v string) {
	o.AuthorityType = &v
}

func (o RecordHttpsCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordHttpsCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordHttpsCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordHttpsCloudInfo := _RecordHttpsCloudInfo{}

	err = json.Unmarshal(data, &varRecordHttpsCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordHttpsCloudInfo(varRecordHttpsCloudInfo)
...
type NullableRecordHttpsCloudInfo struct {
	value *RecordHttpsCloudInfo
	isSet bool
}

func (v NullableRecordHttpsCloudInfo) Get() *RecordHttpsCloudInfo {
	return v.value
}

func (v *NullableRecordHttpsCloudInfo) Set(val *RecordHttpsCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordHttpsCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordHttpsCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordHttpsCloudInfo(val *RecordHttpsCloudInfo) *NullableRecordHttpsCloudInfo {
	return &NullableRecordHttpsCloudInfo{value: val, isSet: true}
}

func (v NullableRecordHttpsCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordHttpsCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
