...
func (o *SharedrecordSrv) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *SharedrecordSrv) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *SharedrecordSrv) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *SharedrecordSrv) SetUuid(v string) {
	o.Uuid = &v
}
