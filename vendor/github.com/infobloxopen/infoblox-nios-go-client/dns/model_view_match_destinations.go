...
func (o *ViewMatchDestinations) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ViewMatchDestinations) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ViewMatchDestinations) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ViewMatchDestinations) SetUuid(v string) {
	o.Uuid = &v
}
