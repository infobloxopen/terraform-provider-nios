...
func (o *ViewMatchClients) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ViewMatchClients) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ViewMatchClients) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ViewMatchClients) SetUuid(v string) {
	o.Uuid = &v
}
