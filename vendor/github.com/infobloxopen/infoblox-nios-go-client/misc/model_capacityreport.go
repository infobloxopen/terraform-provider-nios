...
func (o *Capacityreport) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Capacityreport) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Capacityreport) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Capacityreport) SetUuid(v string) {
	o.Uuid = &v
}
