...
func (o *DiscoveryDevicesupportbundle) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DiscoveryDevicesupportbundle) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DiscoveryDevicesupportbundle) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DiscoveryDevicesupportbundle) SetUuid(v string) {
	o.Uuid = &v
}
