...
func (o *DiscoveryDeviceinterface) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DiscoveryDeviceinterface) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DiscoveryDeviceinterface) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DiscoveryDeviceinterface) SetUuid(v string) {
	o.Uuid = &v
}
