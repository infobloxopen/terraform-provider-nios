...
func (o *DiscoveryDevicecomponent) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DiscoveryDevicecomponent) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DiscoveryDevicecomponent) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DiscoveryDevicecomponent) SetUuid(v string) {
	o.Uuid = &v
}
