...
func (o *DiscoveryDeviceneighbor) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *DiscoveryDeviceneighbor) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *DiscoveryDeviceneighbor) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *DiscoveryDeviceneighbor) SetUuid(v string) {
	o.Uuid = &v
}
