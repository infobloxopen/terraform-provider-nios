...
func (o *NetworkDiscoveryBasicPollSettings) GetUseArpDataForDiscovery() bool {
...
// and a boolean to check if the value has been set.
func (o *NetworkDiscoveryBasicPollSettings) GetUseArpDataForDiscoveryOk() (*bool, bool) {
	if o == nil || IsNil(o.UseArpDataForDiscovery) {
		return nil, false
	}
...
func (o *NetworkDiscoveryBasicPollSettings) HasUseArpDataForDiscovery() bool {
	if o != nil && !IsNil(o.UseArpDataForDiscovery) {
		return true
	}
...
func (o *NetworkDiscoveryBasicPollSettings) SetUseArpDataForDiscovery(v bool) {
