...
func (o *Ipv6networkcontainerDiscoveryBasicPollSettings) GetUseArpDataForDiscovery() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6networkcontainerDiscoveryBasicPollSettings) GetUseArpDataForDiscoveryOk() (*bool, bool) {
	if o == nil || IsNil(o.UseArpDataForDiscovery) {
		return nil, false
	}
...
func (o *Ipv6networkcontainerDiscoveryBasicPollSettings) HasUseArpDataForDiscovery() bool {
	if o != nil && !IsNil(o.UseArpDataForDiscovery) {
		return true
	}
...
func (o *Ipv6networkcontainerDiscoveryBasicPollSettings) SetUseArpDataForDiscovery(v bool) {
