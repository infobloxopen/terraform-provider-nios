...
func (o *Bulkhostnametemplate) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *Bulkhostnametemplate) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *Bulkhostnametemplate) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Bulkhostnametemplate) SetUuid(v string) {
	o.Uuid = &v
}
