...
func (o *Ipv6networkDiscoveryBasicPollSettings) GetUseArpDataForDiscovery() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6networkDiscoveryBasicPollSettings) GetUseArpDataForDiscoveryOk() (*bool, bool) {
	if o == nil || IsNil(o.UseArpDataForDiscovery) {
		return nil, false
	}
...
func (o *Ipv6networkDiscoveryBasicPollSettings) HasUseArpDataForDiscovery() bool {
	if o != nil && !IsNil(o.UseArpDataForDiscovery) {
		return true
	}
...
func (o *Ipv6networkDiscoveryBasicPollSettings) SetUseArpDataForDiscovery(v bool) {
