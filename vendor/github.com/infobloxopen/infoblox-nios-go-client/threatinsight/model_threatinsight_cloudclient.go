...
func (o *ThreatinsightCloudclient) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ThreatinsightCloudclient) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ThreatinsightCloudclient) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ThreatinsightCloudclient) SetUuid(v string) {
	o.Uuid = &v
}
