...
type MsserverDhcp struct {
	...
	Ipv6LastSyncTs *int64 `json:"ipv6_last_sync_ts,omitempty"`
	// Timestamp of the last synchronization attempt
...
// GetIpv6LastSyncTs returns the Ipv6LastSyncTs field value if set, zero value otherwise.
func (o *MsserverDhcp) GetIpv6LastSyncTs() int64 {
	if o == nil || IsNil(o.Ipv6LastSyncTs) {
		var ret int64
		return ret
	}
	return *o.Ipv6LastSyncTs
}

// GetIpv6LastSyncTsOk returns a tuple with the Ipv6LastSyncTs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsserverDhcp) GetIpv6LastSyncTsOk() (*int64, bool) {
	if o == nil || IsNil(o.Ipv6LastSyncTs) {
		return nil, false
	}
	return o.Ipv6LastSyncTs, true
}

// HasIpv6LastSyncTs returns a boolean if a field has been set.
func (o *MsserverDhcp) HasIpv6LastSyncTs() bool {
	if o != nil && !IsNil(o.Ipv6LastSyncTs) {
		return true
	}
...
// SetIpv6LastSyncTs gets a reference to the given int64 and assigns it to the Ipv6LastSyncTs field.
func (o *MsserverDhcp) SetIpv6LastSyncTs(v int64) {
	o.Ipv6LastSyncTs = &v
}
...
func (o MsserverDhcp) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Ipv6LastSyncTs) {
		toSerialize["ipv6_last_sync_ts"] = o.Ipv6LastSyncTs
	}
