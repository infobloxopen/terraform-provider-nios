...
type MsserverDhcpServer struct {
	...
	// flag indicating if the DHCPv4 service is managed
...
// GetV6Managed returns the V6Managed field value if set, zero value otherwise.
func (o *MsserverDhcpServer) GetV6Managed() bool {
	if o == nil || IsNil(o.V6Managed) {
		var ret bool
		return ret
	}
	return *o.V6Managed
...
// GetV6ManagedOk returns a tuple with the V6Managed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsserverDhcpServer) GetV6ManagedOk() (*bool, bool) {
	if o == nil || IsNil(o.V6Managed) {
		return nil, false
	}
	return o.V6Managed, true
}
...
// SetV6Managed gets a reference to the given bool and assigns it to the V6Managed field.
...
func (o MsserverDhcpServer) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.V6Managed) {
		toSerialize["v6_managed"] = o.V6Managed
	}
...
func (o *MsserverDhcpServer) UnmarshalJSON(data []byte) (err error) {
	...
	*o = MsserverDhcpServer(varMsserverDhcpServer)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "v6_managed")
