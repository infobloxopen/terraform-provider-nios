...
func (o *RirOrganization) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *RirOrganization) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *RirOrganization) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *RirOrganization) SetUuid(v string) {
	o.Uuid = &v
}
