...
func (r MsserverDnsAPIListRequest) ProxySearch(proxySearch string) MsserverDnsAPIListRequest {
...
// Search Grid members for data
func (r MsserverDnsAPIReadRequest) ProxySearch(proxySearch string) MsserverDnsAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
