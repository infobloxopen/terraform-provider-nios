...
func (r MssuperscopeAPIListRequest) ProxySearch(proxySearch string) MssuperscopeAPIListRequest {
...
// Search Grid members for data
func (r MssuperscopeAPIReadRequest) ProxySearch(proxySearch string) MssuperscopeAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
