...
func (r MsserverAdsitesDomainAPIListRequest) ProxySearch(proxySearch string) MsserverAdsitesDomainAPIListRequest {
...
// Search Grid members for data
func (r MsserverAdsitesDomainAPIReadRequest) ProxySearch(proxySearch string) MsserverAdsitesDomainAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
