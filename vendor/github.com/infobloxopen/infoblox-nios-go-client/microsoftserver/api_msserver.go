...
func (r MsserverAPIListRequest) ProxySearch(proxySearch string) MsserverAPIListRequest {
...
// Search Grid members for data
func (r MsserverAPIReadRequest) ProxySearch(proxySearch string) MsserverAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
