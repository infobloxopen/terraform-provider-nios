...
func (r MsserverAdsitesSiteAPIListRequest) ProxySearch(proxySearch string) MsserverAdsitesSiteAPIListRequest {
...
// Search Grid members for data
func (r MsserverAdsitesSiteAPIReadRequest) ProxySearch(proxySearch string) MsserverAdsitesSiteAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
