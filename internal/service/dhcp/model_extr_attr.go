...
func ExpandExtAttr(ctx context.Context, tfMap types.Map, diags *diag.Diagnostics) *map[string]dhcp.ExtAttrs {
...
func (m *ExtAttrModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dhcp.ExtAttrs {
	if m == nil {
		return nil
	}
	to := &dhcp.ExtAttrs{
...
func FlattenExtAttr(ctx context.Context, input map[string]dhcp.ExtAttrs, diags *diag.Diagnostics) types.Map {
...
func (m *ExtAttrModel) Flatten(ctx context.Context, from *dhcp.ExtAttrs, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
...
func RemoveInheritedExtAttrs(ctx context.Context, planExtAttrs types.Map, respExtAttrs map[string]dhcp.ExtAttrs) (*map[string]dhcp.ExtAttrs, diag.Diagnostics) {
	var diags diag.Diagnostics
	newRespMap := make(map[string]dhcp.ExtAttrs, len(respExtAttrs))
