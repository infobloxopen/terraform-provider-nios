...
var _ list.ListResource = &Ipv6networktemplateList{}
var _ list.ListResourceWithConfigure = &Ipv6networktemplateList{}

func NewIpv6networktemplateList() list.ListResource {
	return &Ipv6networktemplateList{}
}

// Ipv6networktemplateList defines the List implementation.
type Ipv6networktemplateList struct {
	client *niosclient.APIClient
}

func (l *Ipv6networktemplateList) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + "ipam_ipv6networktemplate"
}

func (l *Ipv6networktemplateList) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
type Ipv6networktemplateListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"extattrfilters"`
}

func (l *Ipv6networktemplateList) ListResourceConfigSchema(ctx context.Context, req list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Query existing IPAM IPv6 Network Templates.",
...
func (l *Ipv6networktemplateList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6networktemplateListModel
	pageCount := 0
	...
	allResults, err := utils.ReadWithPages(
		func(pageID string, maxResultsPerPage int32) ([]ipam.Ipv6networktemplate, string, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6networktemplate, got error: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
	...
	stream.Results = func(push func(list.ListResult) bool) {
		for _, item := range allResults {
			...
			if req.IncludeResource {
				...
				result1 := FlattenIpv6networktemplate(ctx, &item, &result.Diagnostics)
