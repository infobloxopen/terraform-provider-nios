...
func TestAccIpv6networkResource_AutoCreateReversezone(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkAutoCreateReversezone(network, "true"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_DeleteReason(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_delete_reason"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkDeleteReason(network, "test-delete-reason"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
			...
			// Update and Read
			{
				Config: testAccIpv6networkDeleteReason(network, "updated-delete-reason"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_Network(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_network"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			// Update is not applicable as network is an immutable field.
			{
				Config: testAccIpv6networkNetwork(network),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "network", network),
				),
...
func TestAccIpv6networkResource_RestartIfNeeded(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_restart_if_needed"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkRestartIfNeeded(network, "false"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
			...
			// Update and Read
			{
				Config: testAccIpv6networkRestartIfNeeded(network, "true"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_SendRirRequest(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_send_rir_request"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Update and Read
			{
				Config: testAccIpv6networkSendRirRequest(network, "true"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_DiscoveryMember(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkDiscoveryMember(network, discoveryMember),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_EnableDiscovery(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkEnableDiscovery(network, true),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
			...
			// Update and Read
			{
				Config: testAccIpv6networkEnableDiscovery(network, false),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "enable_discovery", "false"),
				),
...
func TestAccIpv6networkResource_EnableImmediateDiscovery(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkEnableImmediateDiscovery(network, true),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
			...
			// Update and Read
			{
				Config: testAccIpv6networkEnableImmediateDiscovery(network, false),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_LogicFilterRules(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_logic_filter_rules"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkLogicFilterRules(network, logicFilterRulesVal),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
			...
			// Update and Read
			{
				Config: testAccIpv6networkLogicFilterRules(network, logicFilterRulesValUpdated),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
...
func TestAccIpv6networkResource_RirOrganization(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network.test_rir_organization"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
...
func TestAccIpv6networkResource_MappedEAAttributes(t *testing.T) {
	...
	var resourceName = "nios_ipam_ipv6network.test_mapped_ea_attributes"
	var v ipam.Ipv6network
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create and Read
			{
				Config: testAccIpv6networkMappedEAAttributes(network, "IP_ADDRESS", "Site"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "use_subscribe_settings", "true"),
			...
			// Update and Read
			{
				Config: testAccIpv6networkMappedEAAttributes(network, "MAC", "Site"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "use_subscribe_settings", "true"),
...
func TestAccIpv6networkResource_Vlans(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Update and Read
			{
				Config: testAccIpv6networkVlansUpdate(network),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkExists(context.Background(), resourceName, &v),
					resource.TestCheckResourceAttrSet(resourceName, "vlans.0.id"),
					resource.TestCheckResourceAttrSet(resourceName, "vlans.0.name"),
...
func testAccIpv6networkAutoCreateReversezone(network, autoCreateReversezone string) string {
	return fmt.Sprintf(`
...
func testAccIpv6networkDeleteReason(network, deleteReason string) string {
	return fmt.Sprintf(`
resource "nios_ipam_ipv6network" "test_delete_reason" {
    network = %q
    delete_reason = %q
}
...
func testAccIpv6networkRestartIfNeeded(network, restartIfNeeded string) string {
	return fmt.Sprintf(`
resource "nios_ipam_ipv6network" "test_restart_if_needed" {
    network = %q
    restart_if_needed = %s
}
...
func testAccIpv6networkSendRirRequest(network, sendRirRequest string) string {
	return fmt.Sprintf(`
resource "nios_ipam_ipv6network" "test_send_rir_request" {
    network = %q
    send_rir_request = %s
}
...
func testAccIpv6networkDiscoveryMember(network, discoveryMember string) string {
	return fmt.Sprintf(`
...
func testAccIpv6networkLogicFilterRules(network string, logicFilterRules []map[string]any) string {
	...
	return fmt.Sprintf(`
resource "nios_ipam_ipv6network" "test_logic_filter_rules" {
    network = %q
...
func testAccIpv6networkRirOrganization(network, rirOrganization string) string {
	return fmt.Sprintf(`
resource "nios_ipam_ipv6network" "test_rir_organization" {
    network = %q
    rir_organization = %q
    extattrs = {
...
func testAccIpv6networkRirRegistrationAction(parentNetwork, childNetwork, rirRegistrationAction string) string {
	return fmt.Sprintf(`
...
resource "nios_ipam_ipv6network" "test_rir_registration_action" {
...
func testAccIpv6networkVlansUpdate(network string) string {
	return fmt.Sprintf(`
resource "nios_ipam_vlanview" "test_vlan_view" {
    start_vlan_id = 50
    end_vlan_id   = 100
...
resource "nios_ipam_vlan" "test_vlan" {
    id     = 50
    name   = "test-vlan-for-ipv6network-updated"
    parent = nios_ipam_vlanview.test_vlan_view.ref
}
