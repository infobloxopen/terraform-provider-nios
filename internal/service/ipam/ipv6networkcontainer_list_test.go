...
func TestAccIpv6networkcontainerList_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Query the object
			{
				ProtoV6ProviderFactories: acctest.ProtoV6ProviderFactories,
				Query:                    true,
				Config:                   testAccIpv6networkcontainerListBasicConfig(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("nios_ipam_ipv6network_container.test", 1),
				},
			},
		},
	})
...
func TestAccIpv6networkcontainerList_Filters(t *testing.T) {
	var resourceName = "nios_ipam_ipv6network_container.test"
	var v ipam.Ipv6networkcontainer
	network := acctest.RandomIPv6Network()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Query the object
			{
				ProtoV6ProviderFactories: acctest.ProtoV6ProviderFactories,
				Query:                    true,
				Config:                   testAccIpv6networkcontainerListConfigFilters(network),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLength("nios_ipam_ipv6network_container.test", 1),
...
func TestAccIpv6networkcontainerList_ExtAttrFilters(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV6ProviderFactories: acctest.ProtoV6ProviderFactories,
				Config: testAccIpv6networkcontainerExtAttrs(network, map[string]string{
					"Site": extAttrValue,
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIpv6networkcontainerExists(context.Background(), resourceName, &v),
			...
			// Query the object
			{
				ProtoV6ProviderFactories: acctest.ProtoV6ProviderFactories,
				Query:                    true,
				Config:                   testAccIpv6networkcontainerListConfigExtAttrFilters(extAttrValue),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLength("nios_ipam_ipv6network_container.test", 1),
				},
			},
...
func testAccIpv6networkcontainerListBasicConfig() string {
	return `
...
func testAccIpv6networkcontainerListConfigFilters(filterValue string) string {
	return fmt.Sprintf(`
list "nios_ipam_ipv6network_container" "test" {
	provider = nios
...
func testAccIpv6networkcontainerListConfigExtAttrFilters(extAttrsValue string) string {
	return fmt.Sprintf(`
list "nios_ipam_ipv6network_container" "test" {
	provider = nios
	config {
