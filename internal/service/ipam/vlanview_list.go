...
var _ list.ListResource = &VlanviewList{}
var _ list.ListResourceWithConfigure = &VlanviewList{}

func NewVlanviewList() list.ListResource {
	return &VlanviewList{}
}

// VlanviewList defines the List implementation.
type VlanviewList struct {
	client *niosclient.APIClient
}

func (l *VlanviewList) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + "ipam_vlanview"
}

func (l *VlanviewList) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
type VlanviewListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"extattrfilters"`
}

func (l *VlanviewList) ListResourceConfigSchema(ctx context.Context, req list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Query existing IPAM Vlan View.",
...
func (l *VlanviewList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data VlanviewListModel
	pageCount := 0
	...
	allResults, err := utils.ReadWithPages(
		func(pageID string, maxResultsPerPage int32) ([]ipam.Vlanview, string, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Vlanview, got error: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
