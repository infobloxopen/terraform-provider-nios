...
func TestAccNetworktemplateDataSource_Filters(t *testing.T) {
	dataSourceName := "data.nios_ipam_networktemplate.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					}, testAccCheckNetworktemplateResourceAttrPair(resourceName, dataSourceName)...)...,
				),
			},
		},
	})
...
func TestAccNetworktemplateDataSource_ExtAttrFilters(t *testing.T) {
	dataSourceName := "data.nios_ipam_networktemplate.test"
	resourceName := "nios_ipam_networktemplate.test"
	var v ipam.Networktemplate
	name := acctest.RandomNameWithPrefix("network-template")
