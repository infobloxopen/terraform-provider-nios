...
func (m *MssuperscopeModelWithFilter) FlattenResults(ctx context.Context, from []microsoft.Mssuperscope, diags *diag.Diagnostics) {
	if len(from) == 0 {
		return
	}
...
func (d *MssuperscopeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves information about existing Mssuperscope objects.",
...
func (d *MssuperscopeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	allResults, err := utils.ReadWithPages(
		func(pageID string, maxResults int32) ([]microsoft.Mssuperscope, string, error) {
