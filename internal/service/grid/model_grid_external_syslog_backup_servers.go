...
type GridExternalSyslogBackupServersModel struct {
...
var GridExternalSyslogBackupServersAttrTypes = map[string]attr.Type{
...
var GridExternalSyslogBackupServersResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandGridExternalSyslogBackupServers(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.GridExternalSyslogBackupServers {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m GridExternalSyslogBackupServersModel
...
func (m *GridExternalSyslogBackupServersModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.GridExternalSyslogBackupServers {
	if m == nil {
		return nil
	}
	to := &grid.GridExternalSyslogBackupServers{
...
func FlattenGridExternalSyslogBackupServers(ctx context.Context, from *grid.GridExternalSyslogBackupServers, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(GridExternalSyslogBackupServersAttrTypes)
	}
	m := GridExternalSyslogBackupServersModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, GridExternalSyslogBackupServersAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *GridExternalSyslogBackupServersModel) Flatten(ctx context.Context, from *grid.GridExternalSyslogBackupServers, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
