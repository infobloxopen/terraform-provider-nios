...
type GridThreatprotectionScheduledDownloadModel struct {
...
var GridThreatprotectionScheduledDownloadAttrTypes = map[string]attr.Type{
...
var GridThreatprotectionScheduledDownloadResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandGridThreatprotectionScheduledDownload(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.GridThreatprotectionScheduledDownload {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m GridThreatprotectionScheduledDownloadModel
...
func (m *GridThreatprotectionScheduledDownloadModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.GridThreatprotectionScheduledDownload {
	if m == nil {
		return nil
	}
	to := &grid.GridThreatprotectionScheduledDownload{
...
func FlattenGridThreatprotectionScheduledDownload(ctx context.Context, from *grid.GridThreatprotectionScheduledDownload, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(GridThreatprotectionScheduledDownloadAttrTypes)
	}
	m := GridThreatprotectionScheduledDownloadModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, GridThreatprotectionScheduledDownloadAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *GridThreatprotectionScheduledDownloadModel) Flatten(ctx context.Context, from *grid.GridThreatprotectionScheduledDownload, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
