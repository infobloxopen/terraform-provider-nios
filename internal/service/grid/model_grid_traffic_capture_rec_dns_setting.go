...
type GridTrafficCaptureRecDnsSettingModel struct {
...
var GridTrafficCaptureRecDnsSettingAttrTypes = map[string]attr.Type{
	...
	"kpi_monitored_domains":            types.ListType{ElemType: types.ObjectType{AttrTypes: GridtrafficcapturerecdnssettingKpiMonitoredDomainsAttrTypes}},
}

var GridTrafficCaptureRecDnsSettingResourceSchemaAttributes = map[string]schema.Attribute{
	...
	"kpi_monitored_domains": schema.ListNestedAttribute{
		NestedObject: schema.NestedAttributeObject{
			Attributes: GridtrafficcapturerecdnssettingKpiMonitoredDomainsResourceSchemaAttributes,
		},
...
func ExpandGridTrafficCaptureRecDnsSetting(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.GridTrafficCaptureRecDnsSetting {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m GridTrafficCaptureRecDnsSettingModel
...
func (m *GridTrafficCaptureRecDnsSettingModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.GridTrafficCaptureRecDnsSetting {
	if m == nil {
		return nil
	}
	to := &grid.GridTrafficCaptureRecDnsSetting{
		...
		KpiMonitoredDomains:         flex.ExpandFrameworkListNestedBlock(ctx, m.KpiMonitoredDomains, diags, ExpandGridtrafficcapturerecdnssettingKpiMonitoredDomains),
	}
	return to
}

func FlattenGridTrafficCaptureRecDnsSetting(ctx context.Context, from *grid.GridTrafficCaptureRecDnsSetting, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(GridTrafficCaptureRecDnsSettingAttrTypes)
	}
	m := GridTrafficCaptureRecDnsSettingModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, GridTrafficCaptureRecDnsSettingAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *GridTrafficCaptureRecDnsSettingModel) Flatten(ctx context.Context, from *grid.GridTrafficCaptureRecDnsSetting, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
	...
	m.KpiMonitoredDomains = flex.FlattenFrameworkListNestedBlock(ctx, from.KpiMonitoredDomains, GridtrafficcapturerecdnssettingKpiMonitoredDomainsAttrTypes, diags, FlattenGridtrafficcapturerecdnssettingKpiMonitoredDomains)
}
