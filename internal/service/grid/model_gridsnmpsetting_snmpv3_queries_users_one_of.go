...
var GridsnmpsettingSnmpv3QueriesUsersOneOfAttrTypes = map[string]attr.Type{
...
var GridsnmpsettingSnmpv3QueriesUsersOneOfResourceSchemaAttributes = map[string]schema.Attribute{
...
// 	if from == nil {
// 		return types.ObjectNull(GridsnmpsettingSnmpv3QueriesUsersOneOfAttrTypes)
// 	}
// 	m := GridsnmpsettingSnmpv3QueriesUsersOneOfModel{}
// 	m.Flatten(ctx, from, diags)
// 	t, d := types.ObjectValueFrom(ctx, GridsnmpsettingSnmpv3QueriesUsersOneOfAttrTypes, m)
// 	diags.Append(d...)
// 	return t
// }
