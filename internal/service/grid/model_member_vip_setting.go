...
func ExpandMemberVipSetting(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.MemberVipSetting {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m MemberVipSettingModel
...
func (m *MemberVipSettingModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.MemberVipSetting {
	if m == nil {
		return nil
	}
...
func FlattenMemberVipSetting(ctx context.Context, from *grid.MemberVipSetting, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(MemberVipSettingAttrTypes)
	}
	m := MemberVipSettingModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, MemberVipSettingAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *MemberVipSettingModel) Flatten(ctx context.Context, from *grid.MemberVipSetting, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
