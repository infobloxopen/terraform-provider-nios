...
type GridntpsettingNtpServersModel struct {
...
var GridntpsettingNtpServersAttrTypes = map[string]attr.Type{
...
var GridntpsettingNtpServersResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandGridntpsettingNtpServers(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.GridntpsettingNtpServers {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m GridntpsettingNtpServersModel
...
func (m *GridntpsettingNtpServersModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.GridntpsettingNtpServers {
	if m == nil {
		return nil
	}
	to := &grid.GridntpsettingNtpServers{
...
func FlattenGridntpsettingNtpServers(ctx context.Context, from *grid.GridntpsettingNtpServers, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(GridntpsettingNtpServersAttrTypes)
	}
	m := GridntpsettingNtpServersModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, GridntpsettingNtpServersAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *GridntpsettingNtpServersModel) Flatten(ctx context.Context, from *grid.GridntpsettingNtpServers, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
