...
type GridCloudapiTenantCloudInfoModel struct {
...
var GridCloudapiTenantCloudInfoAttrTypes = map[string]attr.Type{
	"delegated_member": types.ObjectType{AttrTypes: GridcloudapitenantcloudinfoDelegatedMemberAttrTypes},
...
var GridCloudapiTenantCloudInfoResourceSchemaAttributes = map[string]schema.Attribute{
	"delegated_member": schema.SingleNestedAttribute{
		Attributes: GridcloudapitenantcloudinfoDelegatedMemberResourceSchemaAttributes,
		Optional:   true,
	},
...
func ExpandGridCloudapiTenantCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *grid.GridCloudapiTenantCloudInfo {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m GridCloudapiTenantCloudInfoModel
...
func (m *GridCloudapiTenantCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *grid.GridCloudapiTenantCloudInfo {
	if m == nil {
		return nil
	}
	to := &grid.GridCloudapiTenantCloudInfo{
		DelegatedMember: ExpandGridcloudapitenantcloudinfoDelegatedMember(ctx, m.DelegatedMember, diags),
	}
	return to
}

func FlattenGridCloudapiTenantCloudInfo(ctx context.Context, from *grid.GridCloudapiTenantCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(GridCloudapiTenantCloudInfoAttrTypes)
	}
	m := GridCloudapiTenantCloudInfoModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, GridCloudapiTenantCloudInfoAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *GridCloudapiTenantCloudInfoModel) Flatten(ctx context.Context, from *grid.GridCloudapiTenantCloudInfo, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
	...
	m.DelegatedMember = FlattenGridcloudapitenantcloudinfoDelegatedMember(ctx, from.DelegatedMember, diags)
