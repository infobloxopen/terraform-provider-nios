...
func ExpandExtAttr(ctx context.Context, tfMap types.Map, diags *diag.Diagnostics) *map[string]rpz.ExtAttrs {
...
func (m *ExtAttrModel) Expand(ctx context.Context, diags *diag.Diagnostics) *rpz.ExtAttrs {
	if m == nil {
		return nil
	}
	to := &rpz.ExtAttrs{
...
func FlattenExtAttr(ctx context.Context, input map[string]rpz.ExtAttrs, diags *diag.Diagnostics) types.Map {
...
func (m *ExtAttrModel) Flatten(ctx context.Context, from *rpz.ExtAttrs, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
...
func RemoveInheritedExtAttrs(ctx context.Context, planExtAttrs types.Map, respExtAttrs map[string]rpz.ExtAttrs) (*map[string]rpz.ExtAttrs, diag.Diagnostics) {
	var diags diag.Diagnostics
	newRespMap := make(map[string]rpz.ExtAttrs, len(respExtAttrs))
