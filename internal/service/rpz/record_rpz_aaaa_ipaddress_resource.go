...
var _ resource.Resource = &RecordRpzAaaaIpaddressResource{}
var _ resource.ResourceWithImportState = &RecordRpzAaaaIpaddressResource{}

func NewRecordRpzAaaaIpaddressResource() resource.Resource {
	return &RecordRpzAaaaIpaddressResource{}
}

// RecordRpzAaaaIpaddressResource defines the resource implementation.
type RecordRpzAaaaIpaddressResource struct {
	client *niosclient.APIClient
}

func (r *RecordRpzAaaaIpaddressResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + "rpz_record_aaaa_ipaddress"
}

func (r *RecordRpzAaaaIpaddressResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an RPZ AAAA IPADDRESS record.",
		Attributes:          RecordRpzAaaaIpaddressResourceSchemaAttributes,
	}
}

func (r *RecordRpzAaaaIpaddressResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *RecordRpzAaaaIpaddressResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	res := apiRes.CreateRecordRpzAaaaIpaddressResponseAsObject.GetResult()
	res.ExtAttrs, data.ExtAttrsAll, diags = RemoveInheritedExtAttrs(ctx, data.ExtAttrs, *res.ExtAttrs)
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating RecordRpzAaaaIpaddress due to inherited Extensible attributes")
		return
	}
...
func (r *RecordRpzAaaaIpaddressResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read RecordRpzAaaaIpaddress, got error: %s", err))
		return
	}

	res := apiRes.GetRecordRpzAaaaIpaddressResponseObjectAsResult.GetResult()
	...
	if associateInternalId == nil {
		...
		if stateExtAttrs == nil {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read RecordRpzAaaaIpaddress because the internal ID (from extattrs_all) is missing or invalid.",
			)
			return
		}
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading RecordRpzAaaaIpaddress due to inherited Extensible attributes")
		return
	}
...
func (r *RecordRpzAaaaIpaddressResource) ReadByExtAttrs(ctx context.Context, data *RecordRpzAaaaIpaddressModel, resp *resource.ReadResponse) bool {
	...
	results := apiRes.ListRecordRpzAaaaIpaddressResponseObject.GetResult()
...
func (r *RecordRpzAaaaIpaddressResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	res := apiRes.UpdateRecordRpzAaaaIpaddressResponseAsObject.GetResult()

	res.ExtAttrs, data.ExtAttrsAll, diags = RemoveInheritedExtAttrs(ctx, planExtAttrs, *res.ExtAttrs)
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating RecordRpzAaaaIpaddress due to inherited Extensible attributes")
		return
	}
