...
var ZoneAuthGridPrimaryAttrTypes = map[string]attr.Type{
	...
	"lead":                       types.BoolType,
	"preferred_primaries":        types.ObjectType{AttrTypes: ZoneauthgridprimaryPreferredPrimariesAttrTypes},
...
func (m *ZoneAuthGridPrimaryModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns.ZoneAuthGridPrimary {
	...
	to := &dns.ZoneAuthGridPrimary{
		...
		PreferredPrimaries:       ExpandZoneauthgridprimaryPreferredPrimaries(ctx, m.PreferredPrimaries, diags),
...
func (m *ZoneAuthGridPrimaryModel) Flatten(ctx context.Context, from *dns.ZoneAuthGridPrimary, diags *diag.Diagnostics) {
	...
	m.PreferredPrimaries = FlattenZoneauthgridprimaryPreferredPrimaries(ctx, from.PreferredPrimaries, diags)
