...
type RecordSvcbAwsRte53RecordInfoModel struct {
...
var RecordSvcbAwsRte53RecordInfoAttrTypes = map[string]attr.Type{
...
var RecordSvcbAwsRte53RecordInfoResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandRecordSvcbAwsRte53RecordInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns.RecordSvcbAwsRte53RecordInfo {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m RecordSvcbAwsRte53RecordInfoModel
...
func (m *RecordSvcbAwsRte53RecordInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns.RecordSvcbAwsRte53RecordInfo {
	if m == nil {
		return nil
	}
	to := &dns.RecordSvcbAwsRte53RecordInfo{}
	return to
}

func FlattenRecordSvcbAwsRte53RecordInfo(ctx context.Context, from *dns.RecordSvcbAwsRte53RecordInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(RecordSvcbAwsRte53RecordInfoAttrTypes)
	}
	m := RecordSvcbAwsRte53RecordInfoModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, RecordSvcbAwsRte53RecordInfoAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *RecordSvcbAwsRte53RecordInfoModel) Flatten(ctx context.Context, from *dns.RecordSvcbAwsRte53RecordInfo, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
