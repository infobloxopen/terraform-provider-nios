...
var _ resource.ResourceWithIdentity = &RecordAaaaResource{}
...
func (r *RecordAaaaResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *RecordAaaaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateRecordAaaaResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating RecordAaaa due to inherited Extensible attributes")
		return
	}
...
func (r *RecordAaaaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetRecordAaaaResponse
	)
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading RecordAaaa due to inherited Extensible attributes")
		return
	}
...
func (r *RecordAaaaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateRecordAaaaResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating RecordAaaa due to inherited Extensible attributes")
		return
	}
...
func (r *RecordAaaaResource) UpdateFuncCallAttributeName(ctx context.Context, data RecordAaaaModel, diags *diag.Diagnostics) types.Object {
	...
	if !err {
		diags.AddError("Client Error", fmt.Sprintf("Unable to find attribute '%s' in RecordAaaa model, got error", attrVal))
