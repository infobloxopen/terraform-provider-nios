...
type RecordHttpsAwsRte53RecordInfoModel struct {
...
var RecordHttpsAwsRte53RecordInfoAttrTypes = map[string]attr.Type{
...
var RecordHttpsAwsRte53RecordInfoResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandRecordHttpsAwsRte53RecordInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns.RecordHttpsAwsRte53RecordInfo {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m RecordHttpsAwsRte53RecordInfoModel
...
func (m *RecordHttpsAwsRte53RecordInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns.RecordHttpsAwsRte53RecordInfo {
	if m == nil {
		return nil
	}
	to := &dns.RecordHttpsAwsRte53RecordInfo{}
	return to
}

func FlattenRecordHttpsAwsRte53RecordInfo(ctx context.Context, from *dns.RecordHttpsAwsRte53RecordInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(RecordHttpsAwsRte53RecordInfoAttrTypes)
	}
	m := RecordHttpsAwsRte53RecordInfoModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, RecordHttpsAwsRte53RecordInfoAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *RecordHttpsAwsRte53RecordInfoModel) Flatten(ctx context.Context, from *dns.RecordHttpsAwsRte53RecordInfo, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
