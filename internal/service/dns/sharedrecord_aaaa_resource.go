...
var _ resource.ResourceWithIdentity = &SharedrecordAaaaResource{}
...
func (r *SharedrecordAaaaResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *SharedrecordAaaaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateSharedrecordAaaaResponse
	...
	if diags.HasError() {
		...
		resp.Diagnostics.AddError("Client Error", "Error while creating SharedrecordAaaa due to inherited Extensible attributes")
		return
	}
...
func (r *SharedrecordAaaaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetSharedrecordAaaaResponse
	)
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading SharedrecordAaaa due to inherited Extensible attributes")
		return
	}
...
func (r *SharedrecordAaaaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateSharedrecordAaaaResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating SharedrecordAaaa due to inherited Extensible attributes")
		return
	}
