...
func ExpandRecordHostIpv4addrOptions(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns.RecordHostIpv4addrOptions {
...
func (m *RecordHostIpv4addrOptionsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns.RecordHostIpv4addrOptions {
	if m == nil {
		return nil
	}
	to := &dns.RecordHostIpv4addrOptions{
...
func FlattenRecordHostIpv4addrOptions(ctx context.Context, from *dns.RecordHostIpv4addrOptions, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordHostIpv4addrOptionsModel) Flatten(ctx context.Context, from *dns.RecordHostIpv4addrOptions, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
