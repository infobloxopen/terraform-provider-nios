...
var _ resource.ResourceWithIdentity = &RecordUnknownResource{}
...
func (r *RecordUnknownResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *RecordUnknownResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateRecordUnknownResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating RecordUnknown due to inherited Extensible attributes")
		return
	}
...
func (r *RecordUnknownResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetRecordUnknownResponse
	)
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading RecordUnknown due to inherited Extensible attributes")
		return
	}
...
func (r *RecordUnknownResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateRecordUnknownResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating RecordUnknown due to inherited Extensible attributes")
		return
	}
