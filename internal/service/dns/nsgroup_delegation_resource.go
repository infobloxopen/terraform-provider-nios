...
var _ resource.ResourceWithIdentity = &NsgroupDelegationResource{}
...
func (r *NsgroupDelegationResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *NsgroupDelegationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateNsgroupDelegationResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating NsgroupDelegation due to inherited Extensible attributes")
		return
	}
...
func (r *NsgroupDelegationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetNsgroupDelegationResponse
	)
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading NsgroupDelegation due to inherited Extensible attributes")
		return
	}
...
func (r *NsgroupDelegationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateNsgroupDelegationResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating NsgroupDelegation due to inherited Extensible attributes")
		return
	}
