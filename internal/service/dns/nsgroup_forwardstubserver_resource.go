...
var _ resource.ResourceWithIdentity = &NsgroupForwardstubserverResource{}
...
func (r *NsgroupForwardstubserverResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages NS group Forward Stub Server.",
		Attributes:          NsgroupForwardstubserverResourceSchemaAttributes,
	}
}

func (r *NsgroupForwardstubserverResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *NsgroupForwardstubserverResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateNsgroupForwardstubserverResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating NsgroupForwardstubserver due to inherited Extensible attributes")
		return
	}
...
func (r *NsgroupForwardstubserverResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetNsgroupForwardstubserverResponse
	)
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading NsgroupForwardstubserver due to inherited Extensible attributes")
		return
	}
...
func (r *NsgroupForwardstubserverResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateNsgroupForwardstubserverResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating NsgroupForwardstubserver due to inherited Extensible attributes")
		return
	}
