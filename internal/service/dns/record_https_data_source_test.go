...
func TestAccRecordHttpsDataSource_Filters(t *testing.T) {
	dataSourceName := "data.nios_dns_record_https.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRecordHttpsDataSourceConfigFilters(zoneFqdn, name, priority),
				Check: resource.ComposeTestCheckFunc(
					append([]resource.TestCheckFunc{
						testAccCheckRecordHttpsExists(context.Background(), resourceName, &v),
					}, testAccCheckRecordHttpsResourceAttrPair(resourceName, dataSourceName)...)...,
				),
			},
		},
	})
...
func TestAccRecordHttpsDataSource_ExtAttrFilters(t *testing.T) {
	dataSourceName := "data.nios_dns_record_https.test"
	resourceName := "nios_dns_record_https.test"
	var v dns.RecordHttps
	zoneFqdn := acctest.RandomNameWithPrefix("test-zone") + ".com"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRecordHttpsDataSourceConfigExtAttrFilters(zoneFqdn, name, priority, acctest.RandomName()),
				Check: resource.ComposeTestCheckFunc(
					append([]resource.TestCheckFunc{
						testAccCheckRecordHttpsExists(context.Background(), resourceName, &v),
					}, testAccCheckRecordHttpsResourceAttrPair(resourceName, dataSourceName)...)...,
...
func testAccCheckRecordHttpsResourceAttrPair(resourceName, dataSourceName string) []resource.TestCheckFunc {
