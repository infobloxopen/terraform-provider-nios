...
func TestAccZoneRpDataSource_Filters(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccZoneRpDataSourceConfigFilters(),
...
func TestAccZoneRpDataSource_ExtAttrFilters(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccZoneRpDataSourceConfigExtAttrFilters(, acctest.RandomName()),
				Check: resource.ComposeTestCheckFunc(
					append([]resource.TestCheckFunc{
							testAccCheckZoneRpExists(context.Background(), resourceName, &v),
						}, testAccCheckZoneRpResourceAttrPair(resourceName, dataSourceName)...)...,
...
func testAccZoneRpDataSourceConfigFilters() string {
	return fmt.Sprintf(`
...
data "nios_dns_zone_rp" "test" {
  filters = {
	 = nios_dns_zone_rp.test.
  }
}
`)
}

func testAccZoneRpDataSourceConfigExtAttrFilters(extAttrsValue string) string {
	return fmt.Sprintf(`
resource "nios_dns_zone_rp" "test" {
  extattrs = {
    Site = %q
