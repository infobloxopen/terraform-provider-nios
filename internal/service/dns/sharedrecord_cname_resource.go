...
func (r *SharedrecordCnameResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	apiRes, _, err := r.client.DNSAPI.
		...
		Create(ctx).
		SharedrecordCname(*data.Expand(ctx, &resp.Diagnostics)).
...
func (r *SharedrecordCnameResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if associateInternalId == nil {
		...
		if stateExtAttrs == nil {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read SharedrecordCname because the internal ID (from extattrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *SharedrecordCnameResource) ReadByExtAttrs(ctx context.Context, data *SharedrecordCnameModel, resp *resource.ReadResponse) bool {
	var diags diag.Diagnostics
	...
	results := apiRes.ListSharedrecordCnameResponseObject.GetResult()
