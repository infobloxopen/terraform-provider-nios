...
var _ resource.ResourceWithIdentity = &RecordNsResource{}
...
func (r *RecordNsResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
