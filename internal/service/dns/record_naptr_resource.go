...
var _ resource.ResourceWithIdentity = &RecordNaptrResource{}
...
func (r *RecordNaptrResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *RecordNaptrResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var apiRes *dns.CreateRecordNaptrResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while creating RecordNaptr due to inherited Extensible attributes")
		return
	}
...
func (r *RecordNaptrResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var (
		httpRes *http.Response
		apiRes  *dns.GetRecordNaptrResponse
	)
	...
	if associateInternalId == nil {
		...
		if stateExtAttrs == nil {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read RecordNaptr because the internal ID (from extattrs_all) is missing or invalid.",
			)
			return
		}
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while reading RecordNaptr due to inherited Extensible attributes")
		return
	}
...
func (r *RecordNaptrResource) ReadByExtAttrs(ctx context.Context, data *RecordNaptrModel, resp *resource.ReadResponse) bool {
	var diags diag.Diagnostics
	...
	results := apiRes.ListRecordNaptrResponseObject.GetResult()
...
func (r *RecordNaptrResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var apiRes *dns.UpdateRecordNaptrResponse
	...
	if diags.HasError() {
		resp.Diagnostics.Append(diags...)
		resp.Diagnostics.AddError("Client Error", "Error while updating RecordNaptr due to inherited Extensible attributes")
		return
	}
