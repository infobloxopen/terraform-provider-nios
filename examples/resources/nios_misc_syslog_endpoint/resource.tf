...
resource "nios_misc_syslog_endpoint" "syslogendpoint_1" {
  ...
  syslog_servers       = [{ "address" : "10.1.1.1", "port" : 514, "connection_type" : "udp", "format" : "formatted" }]
}
...
resource "nios_misc_syslog_endpoint" "syslogendpoint_2" {
  ...
  outbound_member_type = "GM"
  syslog_servers       = [{ "address" : "10.1.1.2", "port" : 514, "connection_type" : "udp", "format" : "formatted" }]
